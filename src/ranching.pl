...
enterRanch :-
    (
        ...
        (
            ...
            (inInventory(Chicken)),(itemCounter(Chicken, Count), write('1.'), write(Count), write('chicken.')), nl,
            ...
            (
                User = 1 -> /* ================================ Chicken ================================= */
                (
                    (inInventory(Chicken)),(itemCounter(Chicken, Count),
                    currEgg(EggCount), stamina(_,PrevStamina,_),
                    PrevStamina >= 10 ->
                    (
                        Count == 0 -> 
                        (    
                        ...
                        (
                            ...
                            (
                                ...
                                asserta(storeditem(egg, Count)),
                                write('you have collected '), write(Count), write(' egg.'),
